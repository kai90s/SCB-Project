                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2 text-center">
                      <a href="add_car.php" class="btn btn-primary col-md-11 btn-block active ml-md-3" role="button" aria-pressed="true">Add car</a>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-sm-5 col-md-6">
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2 text-center">
                      <a href="view_car.php" class="btn btn-primary col-md-11 btn-block active ml-md-3" role="button" aria-pressed="true">View car</a>
                    </div>
                    <div class="col-auto">
